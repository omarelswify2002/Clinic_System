export const en = {
  ...
  queue: {
    ...
    searchByNameOrIdOrPhone: 'Search by name, national ID, or phone',
  ...
  prescriptions: {
    ...
    setConsultationDate: 'Set consultation date',
  ...
  appointments: {
    title: 'Appointments',
    subtitle: 'Manage bookings and patient arrivals',
    schedule: 'Today\'s Schedule',
    scheduleDesc: 'See who has arrived and upcoming bookings',
    newBooking: 'New Booking',
    editBooking: 'Edit Booking',
    book: 'Book Appointment',
    clinicHours: 'Clinic Hours',
    clinicHoursDesc: 'Set opening times and slot duration per day',
    timeFormat: 'Time format: 9 AM / 9 PM',
    closed: 'Closed',
    closedDay: 'Clinic is closed on this day',
    ...
    notes: 'Notes',
    notesPlaceholder: 'Optional notes for the visit',
    status: 'Status',
    arrival: 'Arrival',
    arrived: 'Arrived',
    ...
    actions: 'Actions',
    checkIn: 'Check In',
    searchPatient: 'Search patient by name, ID, or phone',
    statuses: {
      booked: 'Booked',
