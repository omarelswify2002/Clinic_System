export const ar = {
  ...
  prescriptions: {
    ...
    setConsultationDate: 'تحديد تاريخ الاستشارة',
  ...
  appointments: {
    title: 'الحجوزات',
    subtitle: 'إدارة الحجوزات وحضور المرضى',
    schedule: 'جدول اليوم',
    scheduleDesc: 'عرض من حضر ومن لم يحضر بعد',
    newBooking: 'حجز جديد',
    editBooking: 'تعديل الحجز',
    book: 'حجز موعد',
    clinicHours: 'ساعات العيادة',
    clinicHoursDesc: 'تحديد أوقات العمل ومدد المواعيد لكل يوم',
    timeFormat: 'تنسيق الوقت: 9 ص / 9 م',
    closed: 'مغلق',
    closedDay: 'العيادة مغلقة في هذا اليوم',
    hoursLabel: 'ساعات العيادة',
    minutes: 'دقائق',
    time: 'الوقت',
    date: 'التاريخ',
    patient: 'المريض',
    ...
    notes: 'ملاحظات',
    notesPlaceholder: 'ملاحظات اختيارية للزيارة',
    status: 'الحالة',
    arrival: 'الحضور',
    arrived: 'حضر',
    notArrived: 'لم يحضر',
    ...
    searchPatient: 'ابحث عن المريض بالاسم أو الرقم أو الهاتف',
    statuses: {
      booked: 'محجوز',
